          ...
          >
            {data.map((item: any) => (
              <div
                ...
                className="bg-white rounded-[30px] p-7 border border-orange-100 shadow-lg cursor-pointer hover:-translate-y-2 transition "
              >
                <div
                  className="w-16 h-16 rounded-2xl bg-orange-500 flex items-center justify-center text-white mb-5 "
                >
                  <BookOpen />
                </div>
